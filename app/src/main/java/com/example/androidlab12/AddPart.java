...
public class AddPart extends AppCompatActivity {
    String Storage_Path = "autoparts_image/";
    String Database_Path = "autoparts";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new android.app.ProgressDialog(AddPart.this);
    ...
    */
    public void uploadFile() {
        ...
        if (filePath != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Autopart autopart = new Autopart(edName.getText().toString().trim(),
                                            Integer.parseInt(edPrice.getText().toString().trim()),
                                            downloadPhotoUrl.toString());

                                    //adding an upload to firebase database
                                    String uploadId = mDatabase.push().getKey();
                                    mDatabase.child(uploadId).setValue(autopart);
                                }
                            });
            ...
            android.widget.Toast.makeText(AddPart.this, "Please Select Image or Add Image Name", android.widget.Toast.LENGTH_LONG).show();
        }
    }
}